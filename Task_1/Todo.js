...
function createComponents(value) {
    ...
    completedButton.innerHTML = "<i class='fa fa-check' style='font-size:18px;color: rgb(32, 229, 250)'>DONE</i>";
    completedButton.classList.add("check-btn"); 
    todoDiv.appendChild(completedButton);

    // Create Trash button
    const trashButton = document.createElement("button");
    trashButton.innerHTML = "<i class='fas fa-trash' style='font-size:20px;color: rgb(32, 229, 250)'>DELETE</i>";
